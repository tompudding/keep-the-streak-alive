...
a = Analysis(['keep_the_streak_alive.py', 'keep_the_streak_alive.spec'],
             pathex=['/home/pudding/Projects/keep_the_streak_alive'],
...
pyz = PYZ(a.pure, a.zipped_data,
             cipher=block_cipher)
image_tree = Tree('/home/pudding/Projects/keep_the_streak_alive/resource', prefix='resource')
shader_tree = Tree('/home/pudding/Projects/keep_the_streak_alive/drawing', prefix='drawing')
